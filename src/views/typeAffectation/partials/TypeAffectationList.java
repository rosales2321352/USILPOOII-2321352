...
import views.unity.partials.UnityAction;

import javax.swing.*;
import javax.swing.table.JTableHeader;
import java.awt.*;

public class TypeAffectationList extends JPanel {
    ...
    public TypeAffectationList(TypeAffectationController controller){
    ...
    public void makeTable(Object[][] information, String[] titles){
        ...
        ManageCellsActionButtons actionsButtons =
                new ManageCellsActionButtons(table,
                        2,
                        new TypeAffectationAction(this.controller),
                        new TypeAffectationAction(this.controller));
